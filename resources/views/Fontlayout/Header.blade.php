                  ...
                  <div>
                    ...
                    >
                      ...
                      >
                        ...
                        <li class="nav-item">
                          <a class="nav-link" href="{{asset('/sports')}}">Sports</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="{{asset('/arts')}}">Art</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="{{asset('/politics')}}">POLITICS</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="{{asset('/travel')}}">Travel</a>
                        </li>
                        <li class="nav-item">
